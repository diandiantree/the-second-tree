...
void EchoServer::showinfo(int clientfd,InetAddress& clientaddr)
{
    std::cout<<TimeStamp::Now().totime()<<"new connection fd="<<clientfd<<" "<<"ip="<<clientaddr.ip()<<" "<<"port="<<clientaddr.port()<<" "<<std::endl;
}